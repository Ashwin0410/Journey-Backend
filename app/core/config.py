...
class Cfg(BaseSettings):
    ...
    # =============================================================================
    # CHANGE #7: VAPID keys for Web Push Notifications
    # =============================================================================
    # Generate these keys using: npx web-push generate-vapid-keys
    # Or use: from pywebpush import webpush; webpush.generate_vapid_keys()
    # Store the private key securely in .env file
