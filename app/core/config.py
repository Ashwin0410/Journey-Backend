...
#     VOICE_INCEPTION_PRIMARY: Optional[str] = None
#     VOICE_INCEPTION_SECONDARY: Optional[str] = None
#     VOICE_INTERSTELLAR_PRIMARY: Optional[str] = None
#     VOICE_INTERSTELLAR_SECONDARY: Optional[str] = None
#     VOICE_THINK_PRIMARY: Optional[str] = None
#     VOICE_THINK_SECONDARY: Optional[str] = None
#     VOICE_JJ: Optional[str] = None
#     VOICE_SEVAN: Optional[str] = None
...
#     CHILL_ROOT: str = "./chillsdb"
#     OUT_DIR: str = "./app/out"
#     PUBLIC_BASE_URL: str = "https://beta.rewire.bio"  # UPDATED
#     DB_URL: str = "sqlite:///./app/journey.db"

#     # Accept JSON list or comma-separated string in .env
#     ALLOWED_ORIGINS: List[str] = [
#         "https://beta.rewire.bio",    # UPDATED
#         "https://rewire.bio",         # UPDATED
#         "http://localhost:5173",
#         "http://localhost:8000",
#     ]
...
#     VOICE_CARTER: Optional[str] = "bU2VfAdiOb2Gv2eZWlFq"  # <- newly added
...
#     ELEVENLABS_API_KEY: str
#     GOOGLE_MAPS_API_KEY: Optional[str] = None  # 🔹 NEW
#     # --- Paths / infra ---
#     CHILL_ROOT: str = "./chillsdb"
#     OUT_DIR: str = "./app/out"
#     PUBLIC_BASE_URL: str = "https://beta.rewire.bio"  # UPDATED
