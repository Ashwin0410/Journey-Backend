...
# from ..schemas import JournalEntryIn, JournalEntryOut, JournalTimelineOut
...
#     """
#     Create a journal / insight / activity landmark entry.

#     Used by:
#     - Home 'Quick Capture' (entry_type="journal")
#     - Post-session insight note (entry_type="insight")
#     - Activity completion, therapy future markers, etc.
#     """
...
# ):
#     """
#     Timeline feed for the 'Map' screen.

#     Splits entries into:
#     - future: date > today
#     - today: date == today
#     - past: date < today (most recent first)
#     """
...
#     # sort past in reverse chronological order (most recent first)
...
def update_journal_entry(
    ...
    """
    Edit an existing journal / insight / activity entry.
    Used when tapping a past entry on the Map / Timeline.
    """
